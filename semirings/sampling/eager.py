...
class Expon(Semiring):
    """Eagerly-sampled exponential variate carried alongside a derivation.

    At construction, samples X ~ Exponential(w) once and caches (X, d) in
    `self.value`. Addition takes the minimum of two variates; multiplication
    is... provisional — see inline XXX.
    """
